...
struct ResponseBody: Decodable {
    ...
    struct MainResponse: Decodable {
        var temp: Double
        var feelsLikeMain: Double
        var tempMinMain: Double
        var tempMaxMain: Double
        var pressure: Double
        var humidity: Double
    }
...
extension ResponseBody.MainResponse {
    var feelsLike: Double { return feelsLikeMain }
    var tempMin: Double { return tempMinMain }
    var tempMax: Double { return tempMaxMain }
}
